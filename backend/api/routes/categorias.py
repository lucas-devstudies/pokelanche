...
def listar_categorias():
    sanduiches = [
        {"id": 36, "titulo": "X-Pikachu", "url": "../assets/36.png", "descricao": "Uma explosão de sabores", "valor": 27},
    ...
    gastronomiaII = [
        {"id": 19, "titulo": "Pizza de Feijão e Ovo", "url": "../assets/19.png", "descricao": "Uma explosão de sabores", "valor": 29.99},
